exports.bangunRuangKubus = (req, res) => {
...
exports.bangunRuangLimas = (req, res) => {
    ...
    let luaslimas = 2 * (panjanglimas * lebarlimas + panjanglimas * tinggilimas + lebarlimas * tinggilimas)
...
exports.bangunRuangTabung = (req, res) => {
    ...
    let luastabung = 2 * 22 / 7 * jarijaritabung * (jarijaritabung + tinggitabung)
...
exports.bangunRuangBola = (req, res) => {
    ...
    let volumebola = 4 / 3 * 22 / 7 * jarijaribola * jarijaribola * jarijaribola
